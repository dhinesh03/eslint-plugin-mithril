# Enforce curly braces or disallow unnecessary curly braces in JSX props and/or children. (mithril/jsx-curly-brace-presence)
...
```js
...
"mithril/jsx-curly-brace-presence": [<enabled>, { "props": <string>, "children": <string> }]
...
```
...
```js
...
"mithril/jsx-curly-brace-presence": [<enabled>, <string>]
...
```
